...
SOURCE_FILE="./redis-6380.conf"
DESTINATION_FILE="/etc/redis/redis-6380.conf"
...
SOURCE_FILE="./redis-server-6380.service"
DESTINATION_FILE="/etc/systemd/system/redis-server-6380.service"
...
SERVICE_NAME="redis-server-6380"
