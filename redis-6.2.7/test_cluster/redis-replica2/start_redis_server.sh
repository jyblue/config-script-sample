...
SOURCE_FILE="./redis-6381.conf"
DESTINATION_FILE="/etc/redis/redis-6381.conf"
...
SOURCE_FILE="./redis-server-6381.service"
DESTINATION_FILE="/etc/systemd/system/redis-server-6381.service"
...
SERVICE_NAME="redis-server-6381"
